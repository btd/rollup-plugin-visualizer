...
function color(node) {
  if (node.children && node.children.length) {
    ...
    var hasNodeModules = !!parents.filter(function(n) {
...
function mouseover(d) {
  ...
  select(".details-name").text(d.data.name);

  select(".details-percentage").text(percentageString);

  select(".details-size").text(formatBytes(d.value));
